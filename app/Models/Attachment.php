...
class Attachment extends Model
{
    ...
    protected $fillable = ['submission_id', 'user_id', 'original_name', 'mime', 'size', 'storage_key', 'status', 'rejection_reason'];
    ...
    public function isScanned() { return $this->status === self::STATUS_SCANNED; }
